...
class QRPage:
    def __init__(self, parent):
        ...
        tk.Label(self.frame, text="QR Generator",
        ...
        tk.Button(btns, text="Generate QR", bg="#4CAF50", fg="white",
                  width=16, height=2, command=self.generate_qr).grid(row=0, column=0, padx=5, pady=5)
        ...
        tk.Button(btns, text="Print", bg="#FF5722", fg="white",
                  width=16, height=2, command=self.print_qr).grid(row=1, column=1, padx=5)
    ...
    def generate_qr(self):
        ...
        if not data:
            ...
            return
        self.qr_img = qrcode.make(data)
        img = ImageTk.PhotoImage(self.qr_img.resize((220, 220)))
    ...
    def print_qr(self):
        ...
        os.startfile("temp_qr.png", "print")
